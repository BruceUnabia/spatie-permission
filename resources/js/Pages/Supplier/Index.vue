...
<template>
    <Head title="Supplier" />
        <Sidebar>
            <template #header>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">Supplier List</h2>
            </template>
                                ...
                                <!-- <tbody class="text-gray-600 text-sm font-light">
                                    <tr class="border-b border-gray-200 hover:bg-gray-50" v-for="sup in suppliers" :key="sup.id">
                                        ...
                                        <td class="py-3 px-6 text-left">
                                            <div class="flex items-center">
                                                <div class="mr-2">
                                                    <img class="w-6 h-6 rounded-full" src="https://i.pinimg.com/736x/a6/a8/18/a6a81882dff10ab366925a7b319c9889.jpg"/>
                                                </div>
                                                <span>{{ sup.email }}</span>
                                            </div>
                                        </td>
